...
function calculate_position_y(current_y_pos,current_velocity_y,current_acceleration_y)
    ...
    velocity_y = current_velocity_y + (acceleration_y+current_acceleration_y)*Resolution/2 # update velocity 
...
function calculate_position_x(current_x_pos,current_velocity_x,current_acceleration_x)
    ...
    velocity_x = current_velocity_x + (acceleration_x+current_acceleration_x)*Resolution/2 # update velocity 

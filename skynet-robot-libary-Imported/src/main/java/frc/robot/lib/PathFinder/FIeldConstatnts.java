    ...
    public static class FieldConstants {
        ...
        public static class Community {
            ...
            public static final Translation2d[] chargingStationCorners = new Translation2d[] {
                    new Translation2d(chargingStationInnerX, chargingStationRightY), // LB
                    new Translation2d(chargingStationInnerX, chargingStationLeftY), // LT
                    new Translation2d(chargingStationOuterX, chargingStationRightY), // RB
                    new Translation2d(chargingStationOuterX, chargingStationLeftY) // RT
            };
